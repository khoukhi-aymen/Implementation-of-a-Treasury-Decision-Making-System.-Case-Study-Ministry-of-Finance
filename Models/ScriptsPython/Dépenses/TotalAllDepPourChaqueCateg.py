...
def format_predictions(test_data, y_pred):
    ...
    for i, prediction in enumerate(y_pred):
        ...
        prediction_str = f"Categorie: {test_data[i][0]}, TotalMontantDepense:  {prediction}, DATE: {(datetime(1970, 1, 1) + timedelta(days=days)).strftime('%Y-%m-%d')}"
...
for line in lines:
    ...
    # Extraire les valeurs de colonne pour 'Categorie', 'TotalMontantDepense:' et 'DATE'
...
# plot_tree_with_size(25, 25)  # Zoom-out
